    ...
    return ( 
        <div className="mainlist">
            ...
            <ol>
                ...
                <li>INVESTOR COMPENSATION FUND
                    <p>We participate in the Investor Compensation Fund for clients of Investment Firms regulated in the Republic of US. You will be entitled to compensation under the Investor Compensation Fund where we are unable to meet our duties and obligations arising from your claim.</p>
                    <p>Any compensation provided to you by the Investor Compensation Fund shall not exceed twenty thousand Euros (€20.000), applies to your aggregate claims against us.</p>
                </li>
                <li>COMPLAINTS PROCEDURE
                    <p>We are obliged to put in place internal procedures for handling complaints fairly and promptly. You may submit a complaint to us, for example by letter, telephone, email, or in person. We will send you a written acknowledgement of your complaint promptly following receipt, enclosing details of our complaints procedures, including when and how you may be able to refer your complaint to the US Financial Services Authority (MFSA) which is the relevant regulatory body. Please refer to our Complaints Procedure for further information on how we deal with complaints.</p>
